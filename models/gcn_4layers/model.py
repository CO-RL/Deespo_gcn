...
class GCN(nn.Module):
    def __init__(self, cfg, nclass=1, dropout=0.5):
        ...
        self.gc2 = GraphConvolution(cfg['data']['total_nodes'], 128, 64)
        self.gc3 = GraphConvolution(cfg['data']['total_nodes'], 64, 32)
        self.gc4 = GraphConvolution(cfg['data']['total_nodes'], 32, nclass)
